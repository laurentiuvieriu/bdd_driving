...
FLAGS.pretrained_model_path = "/media/radu/data/python/bdd_driving/models/tf.caffenet.bin"
FLAGS.data_dir = "/media/radu/data/python/bdd_driving/tfrecords"
